...
declare global {
  ...
  const cachedEventHandler: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const nitroPlugin: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useQuery: typeof import('h3')['useQuery']
  const useRawBody: typeof import('h3')['useRawBody']
  const useRuntimeConfig: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('C:/workspace/nuxt-web-plus/node_modules/nitropack/dist/runtime')['useStorage']
