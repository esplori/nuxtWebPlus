        ...
        <div class="recommand">
          <div class="carousel">
            <div class="carousel-item" v-if="state.siteInfo.carouselEnable==='Y'">
              ...
              >
                <el-carousel-item
                  v-for="(item, index) in state.carouselList.slice(
                    0,
              ...
              <div class="small-carousel">
                <div class="small-carousel-item">
                  <img
                    :src="state.carouselList[state.carouselList.length - 2].imgUrl"
                    alt=""
                  ...
                  <div class="sml-car-title">
                    <a
                      target="_blank"
                      :href="state.carouselList[carouselList.length - 2].url"
                      >{{ state.carouselList[carouselList.length - 2].desc }}</a
                    >
                  </div>
                </div>
                <div class="small-carousel-item">
                  <img
                    :src="state.carouselList[state.carouselList.length - 1].imgUrl"
                    alt=""
                    class="small-carousel-img"
                  />
                  <div class="sml-car-title">
                    <a
                      target="_blank"
                      :href="state.carouselList[state.carouselList.length - 1].url"
                      >{{ state.carouselList[state.carouselList.length - 1].desc }}</a
                    >
                  </div>
                </div>
              </div>
...
import listBody from "@/components/home/pageListBody.vue"
...
state.res = await useFetch("http://admin.dsiab.com/bootService/pages/getList/1");
state.homeList = state.res.data.data

// console.log(state.res.data.data.result);
// export default {
//   components: {
